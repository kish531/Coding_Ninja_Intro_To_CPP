...
Output Format :For each test case, If row sum is maximum, then print: "row" <row_index> <row_sum> ORIf column sum is maximum, then print: "column" <col_index> <col_sum>
...
void findLargest(int **input, int nRows, int mCols){
    int rowMax=INT_MIN, rowIndex=0, colMax=INT_MIN, colIndex=0;
